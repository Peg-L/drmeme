  ...
  <footer class="footer bg-dark py-14">
    <div class="container d-flex justify-content-between align-items-center">
      <div>
        ...
        <p class="text-secondary-700 fs-sm mt-1">
      ...
      <div class="d-flex flex-column align-items-end">
        ...
        <ul class="mt-10 list-unstyled d-flex gap-10">
          <li>
            <a
              class="text-light text-center d-flex flex-column align-items-center w-56px hover-primary-500"
